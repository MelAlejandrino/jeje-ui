...
import {useVirtualizedDropdown} from "./use-virtualized-dropdown";
import {countries, sampleData} from "./constant";

export const VirtualizedDropdownPageView = () => {
    const {single, setSingle, multi, setMulti, large, setLarge} =
        useVirtualizedDropdown();
    ...
    return (
        <>
            ...
            <div>
                ...
                <CopyCommand command="npx jejeui add virtualized-dropdown"/>
            </div>
            ...
            <div>
                ...
                <pre
                    className="overflow-x-auto rounded-lg border border-border bg-muted px-4 py-3 font-mono text-sm text-muted-foreground">
